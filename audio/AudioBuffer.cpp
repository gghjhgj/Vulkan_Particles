      ...
      m_channels(channels)
{
    if (sampleRate == 0)
    {
        throw std::invalid_argument(
            "AudioBuffer: sample rate cannot be zero"
        );
    }
    ...
    {
        throw std::invalid_argument(
            "AudioBuffer: channels cannot be zero"
        );
    }
    ...
    {
        throw std::invalid_argument(
            "AudioBuffer: history cannot be zero"
        );
    }
    ...
    {
        throw std::invalid_argument(
            "AudioBuffer: calculated capacity is zero"
        );
    }
...
)
{
    ...
    const size_t secondPart =
        sampleCount - firstPart;
